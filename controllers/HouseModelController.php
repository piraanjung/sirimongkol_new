...
use app\models\HouseModelSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * HouseModelController implements the CRUD actions for HouseModel model.
 */
class HouseModelController extends Controller
{
    ...
    {
        $this->layout = "admin";
        $searchModel = new HouseModelSearch();
     ...
     * @param integer $id
     * @return HouseModel the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = HouseModel::findOne($id)) !== null) {
            return $model;
        }
